...
log_dir="${repo_dir}/logs/grid3d_risk_prediction_windfield_v1_0414"
mkdir -p "${log_dir}"
...
for config in "${configs[@]}"; do
  ...
  exp_dir="${repo_dir}/checkpoint/grid3d_risk_prediction_windfield_v1_0414_runs/${run_id}/${model_dir}_seed42"
